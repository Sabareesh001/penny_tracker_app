     ...
     return(
        <View style={styles.pageContainer}>
            ...
            <View style={styles.incomeContainer}>
                <View style={{flex:9}}>
            {!monthyIncomeLoading?<TextField keyboardType="number-pad" inputMode="numeric" onChangeText={(e)=>{setMonthlyIncome(()=>{
                const converted = Number(e.split(" ")[1])
                return isNaN(converted)?0:converted
            })}} editable value={`${currencySymbol} ${monthyIncome.toFixed(0)}`}>
            </TextField>:<Skeleton></Skeleton>}
                </View>
            ...
            <View style={styles.incomeContainer}>
                <View style={{flex:9}}>
            {!monthySavingLoading?<TextField keyboardType="number-pad" inputMode="numeric" onChangeText={(e)=>{setMonthySavingsTarget(()=>{
